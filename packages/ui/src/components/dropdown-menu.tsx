...
/**
 * DropdownMenu — a thin Refined-Console skin over Radix's dropdown primitive.
 * Keeps the same surface tokens (border/bg-card/shadow) as Dialog so menus and
 * modals feel like one system. Used for the topbar station switcher and any
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[12rem] overflow-hidden rounded-lg border border-border bg-card p-1 text-sm shadow-xl',
