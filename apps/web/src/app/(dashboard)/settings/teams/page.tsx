...
export default function TeamsPage() {
  ...
  return (
    <div className="flex flex-col gap-7">
      ...
      {!stationID ? (
        <EmptyState title="No station selected" description="Pick a station to configure its teams." />
      ) : teams.isError ? (
        <ErrorState
                          ...
                          return (
                            <PermissionGate key={e.id} permission="station.manage">
                              <button
                                ...
                                title={
                                  onOtherTeam ? 'Currently on another team — click to move here' : ''
                                }
                                className={
                                  onThisTeam
                              ...
                              >
                                {onThisTeam ? <Check className="size-3" /> : <Plus className="size-3" />}
                                {e.full_name}
