...
**Counts (64 feature rows):** 23 DONE · 32 PARTIAL · 8 MISSING · 0 NEEDS QUALITY PASS · 0 DECISION REQUIRED · 1 VERIFY.
...
| Feature | Priority | Backend domain | Frontend route | Required database tables | Required API endpoints | Required SDK methods | Required permissions | Required audit events | Required tests | Status |
|---|---|---|---|---|---|---|---|---|---|---|
| 6.1 Customer management | P0 | internal/receivables | /customers, /customers/[id] | customers, customer_credit_terms | CRUD /customers | customers.* | credit.customer.manage, credit.limit.change | customer.created, customer.updated, customer.credit_limit_changed | unit, integration, permission | PARTIAL |
